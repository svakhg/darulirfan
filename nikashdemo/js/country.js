...
function printCountryOptions(country,selected)
{
	for(key in countrys)
	{
            if(key==selected){
               document.write('<option value="' + countrys[key] + '" selected>' +countrys[key] + '</option>'); 
            }
            else{
		document.write('<option value="' + countrys[key] + '">' +countrys[key] + '</option>');
...
//	{
//            if(key==selected){
//               document.write('<option value="' + key + '" selected>' +countrys[key] + '</option>'); 
//            }
//            else{
