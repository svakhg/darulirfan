...
function transactionCtrl($scope, $http) {
    ...
    loadData('get_payment_type_list', {}).success(function (data) {
        $scope.payment_typeList = data;
    });
    loadData('get_status_list', {}).success(function (data) {
