...
class payment_type_ctrl extends base_ctrl {
	function __construct() {
		parent::__construct();		
	    $this->load->model('payment_type_model','model');
	}
	public function index()
	{
		if($this->is_authentic($this->auth->RoleId, $this->user->UserId, 'payment_type')){
			...
			$this->load->view('payment_type_view', $data);
		}
		else
		{
