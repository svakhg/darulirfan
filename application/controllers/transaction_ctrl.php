...
class transaction_ctrl extends base_ctrl {
	...
	{
		if($this->is_authentic($this->auth->RoleId, $this->user->UserId, 'transaction')){
	...
	public function get_payment_type_list(){
		print  json_encode($this->model->get_payment_type_list());
	}
