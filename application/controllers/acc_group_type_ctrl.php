...
class acc_group_type_ctrl extends base_ctrl {
	function __construct() {
		parent::__construct();		
	    $this->load->model('acc_group_type_model','model');
	}
	public function index()
	{
		if($this->is_authentic($this->auth->RoleId, $this->user->UserId, 'acc_group_type')){
			...
			$this->load->view('acc_group_type_view', $data);
		}
		else
		{
