           ...
           <div class="form-horizontal form-widgets col-lg-6">
               <fieldset>
                   ...
                   <div class="form-group">
                       <label class="control-label col-sm-4"for="designation">Designation</label>
                       <div class="col-md-6">
                       <select kendo-drop-down-list="designationDropdown" ng-model="employee.designation"
                          k-data-text-field="'text'"
                          k-data-value-field="'value'"
                          k-option-label="'Please select'"
                          k-data-source="designationDataSource">
                      </select>
                      <!-- <input id="designation" type="text" ng-model="employee.designation" name="Designation" required class="k-textbox" placeholder=""/> -->
                  </div>
              </div>
              <div class="form-group">
               <label class="control-label col-sm-4">
   ...
   <div class="form-horizontal form-widgets col-lg-6">
       <fieldset>
          ...
          <div class="form-group">
           <label class="control-label col-sm-4"for="status">Employee Status</label>
           <div class="col-md-6">
           <select kendo-drop-down-list="statusDropdown" ng-model="employee.status"
                          k-data-text-field="'text'"
                          k-data-value-field="'value'"
