<script src="static/appScript/departmentCtrl.js"></script>
...
<div ng-show="!fgShowHide" style="display:none">
	<form name="myForm" class="form-horizontal well">
	   <fieldset>  
		  ...
		  <div class="control-group" ng-class="{error: myForm.Department_Name.$invalid}">
		<label class="control-label" for="Department_Name">Department Name</label>
		<div class="controls">
		  <input class="input-xlarge" type="text" name="Department_Name" id="Department_Name" ng-model="item.Department_Name" required />
		  <span ng-show="myForm.Department_Name.$error.required" class="help-inline">Required</span>
		</div>
	  </div>
...
<div modal="searchDialog"  options="opts">
        ...
        <div class="modal-body">
           <form name="myForm" class="form-horizontal">
  			 <div class="control-group" ><label class="control-label" for="Department_Name">Department_Name</label>
		<div class="controls">
		  <input class="input-xlarge" type="text"  ng-model="search.Department_Name" />		  
		</div></div>
