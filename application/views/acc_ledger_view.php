<script src="static/appScript/acc_ledgerCtrl.js"></script>
<script>function getAuth(){ <?php echo $fx ?>;}</script>
<?php if ($read): ?>
<div ng-controller="acc_ledgerCtrl">
...
<div ng-show="!fgShowHide" style="display:none">
 ...
 <div class="control-group" ng-class="{error: myForm.group_id.$invalid}">
		<label class="control-label" for="group_id">group_id</label>
		<div class="controls">
		  <select ng-options="s.id as s.Group_Name for s in acc_groupList"  name="group_id" id="group_id" ng-model="item.group_id" required ></select>
		  <span ng-show="myForm.group_id.$error.required" class="help-inline">Required</span>
		</div>
	  </div>
...
<div class="control-group" ><label class="control-label" for="group_id">group_id</label>
		<div class="controls">
		  <select ng-options="s.id as s.Group_Name for s in acc_groupList"   ng-model="search.group_id" ></select>		  
		</div></div>
